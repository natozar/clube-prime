...
async function gerarArtigo(dados) {
  ...
  const relatedHtml = (dados.relacionados || []).map(r => `
                <a href="/${r.slug}" class="related-card">
                    <img src="${r.imageUrl || 'https://images.unsplash.com/photo-1588347818481-17b5fda1ae59?w=400&h=225&fit=crop'}" alt="${r.titulo}" width="400" height="225" loading="lazy">
  ...
  const replacements = {
    ...
    '{{IMAGE_URL}}': dados.imageUrl || `https://images.unsplash.com/photo-1588347818481-17b5fda1ae59?w=1200&h=630&fit=crop`,
